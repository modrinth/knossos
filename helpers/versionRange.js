  ...
  constructor(range) {
    if (range === "*" || range === "" || range === "x" || range === "X") {
      ...
      this.tester = (version) => version[0] === this.version[0]
        && (this.version[1] === -1 || version[1] === this.version[1])
        && (this.version[2] === -1 || version[2] === this.version[2]);
      ...
      let common = (version) => version[0] > this.version[0] || (version[0] === this.version[0] && version[1] > this.version[1])
      if (range[1] === '=') {
        this.tester = (version) => common(version) || (version[0] === this.version[0] && version[1] === this.version[1] && version[2] >= this.version[2]);
      } else {
        this.tester = (version) => common(version) || (version[0] === this.version[0] && version[1] === this.version[1] && version[2] > this.version[2]);
      }
    ...
    if (this.result) {
      this.version = [
        this.result[1] ? Number.parseInt(this.result[1], 10) : -1, // major
        this.result[2] ? Number.parseInt(this.result[2], 10) : -1, // minor
        this.result[3] ? Number.parseInt(this.result[3], 10) : -1  // patch
      ]
    }
  }
