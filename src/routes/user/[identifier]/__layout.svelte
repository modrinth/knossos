...
<script lang="ts">
  ...
  import { project } from '../../[type]/[identifier]/_store'
  ...
  function editUser() {
    ...
    const body = {
      ...(modifiedUser.username !== $currentUser.username ? ({username: modifiedUser.username}) : ({})),
...
<div class="column-layout">
  <div class="column-layout__sidebar">
    <div class="card card--pad-top card--gap-compressed">
      ...
      {#if isEditing}
        <b>Username</b>
        <Input type="text" placeholder="Enter username..." bind:value={modifiedUser.username} />

        <b>Bio</b>
        <Input type="textarea" placeholder="Add a bio..." bind:value={modifiedUser.bio} />
