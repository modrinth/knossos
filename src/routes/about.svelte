...
<Meta
    title={$t("pages.about")}
    description="Founded in 2020, Modrinth was created to provide modders with an open and intuitive platform to publish their projects on."
/>
...
<div class="single-layout">
    ...
    <div class="card text">
        <h2>History</h2>
        <p>
            Founded in 2020, Modrinth was created to provide modders with an
            open and intuitive platform to publish their projects on.
        </p>

        <p>
            Our primary goal is to be as open as possible, with all our code
            being
        ...
        <p>
            On the technical level, Modrinth is made up of two main components:
            the Rust-based backend named
            <a target="_blank" href="https://github.com/modrinth/labrinth"
                >Labrinth</a
            >, and the Svelte-based frontend named
        ...
        <p>
            Additionally, some other custom-created resources exist, including
            but not limited to:
            ...
            >, an authentication provider. All of Modrinth's code can be found
            on
