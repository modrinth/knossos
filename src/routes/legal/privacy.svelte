...
<p>
    ...
    contains types of information that is collected and recorded by Modrinth and
    how we use it.
</p>
...
<p>
    ...
    and links that appear on Modrinth, which are sent directly to users'
...
<p>
    ...
    and/or collect in Modrinth. This policy is not applicable to any information
