...
<p>
    ...
    <nuxt-link to="/legal/terms">Terms of Service</nuxt-link>, all Projects (a
    form of Content as defined there) must obey the following Rules.
</p>
...
<ul>
    ...
    <li>
        to disrupt, damage, or otherwise cause harm to an individual, computer,
        or network
    </li>
</ul>
...
<p>
    Projects must make a clear attempt to describe their function on the page(s)
    where it may be found and must not omit critical information a user must
    know before installing a Project.
</p>

<h2 id="misleading">3. Misleading Claims</h2>

<p>
    Projects must not make intentionally wrong or misleading claims about the
...
<p>
    Projects must be uploaded only by someone who has the legal license to do
    so.
</p>
...
<p>
    Modrinth reserves the right to remove any file, Project, or other Content
    uploaded to our platform which the Modrinth moderators deem is in violation
    of the Terms and/or Rules outlined in this document. Modrinth also reserves
    the right to introduce new rules at any time, which may or may not
    retroactively apply to already uploaded Content at the Modrinth moderators'
    discretion.
</p>
