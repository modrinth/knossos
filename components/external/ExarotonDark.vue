<template>
  <svg
    ...
    style="enable-background: new 0 0 1049.8 200.4"
    xml:space="preserve"
  >
    <g>
      <path
        fill="#FFFFFF"
        d="M640.1,47.1h-6.5c-9.6,0-18.9,3.8-24.9,9.8c-1.3,1.3-3.5,0.4-3.5-1.4v-4.3c0-1.1-0.9-2-2-2h-20.5
      ...
      <path
        fill="#FFFFFF"
        d="M822.3,133.7h-15.7c-5.3,0-9-3.5-9-8.6V68.4c0-1.1,0.9-2,2-2h21.7c1.1,0,2-0.9,2-2V48c0-1.1-0.9-2-2-2h-21.7
      ...
      <path
        fill="#FFFFFF"
        d="M1004.6,46.3c-12.7,0-21.3,6.4-25.7,10.7c-1.3,1.3-3.4,0.4-3.4-1.4v-4.4c0-1.1-0.9-2-2-2H953c-1.1,0-2,0.9-2,2
      ...
      <path
        fill="#FFFFFF"
        d="M411.7,98.5c-0.5-0.7-0.5-1.7,0-2.4l32.5-43.8c1-1.3,0-3.2-1.6-3.2h-24.9c-0.7,0-1.3,0.3-1.7,0.9l-17.5,27.2
      ...
      <path
        fill="#FFFFFF"
        d="M345.4,100.2c0-32.2-22.2-53.9-55.3-53.9s-55.3,21.6-55.3,53.9c0,32.2,22.2,53.9,55.3,53.9
      ...
      <path
        fill="#FFFFFF"
        d="M559,49.2h-20.5c-1.1,0-2,0.9-2,2v5.9c0,1.8-2.1,2.7-3.4,1.4c-7.6-7.6-19.3-12.1-29.6-12.1
      ...
      <path
        fill="#FFFFFF"
        d="M697.4,46.3c-33.1,0-55.3,21.6-55.3,53.9c0,32.2,22.2,53.9,55.3,53.9s55.3-21.6,55.3-53.9
      ...
      <path
        fill="#FFFFFF"
        d="M883,46.3c-33.1,0-55.3,21.6-55.3,53.9c0,32.2,22.2,53.9,55.3,53.9s55.3-21.6,55.3-53.9
		C938.3,67.9,916,46.3,883,46.3z M913.2,107c0,13.6-11.1,24.6-24.6,24.6h-11.3c-13.6,0-24.6-11.1-24.6-24.6V93.1
		c0-13.6,11.1-24.6,24.6-24.6h11.3c13.6,0,24.6,11.1,24.6,24.6V107z"
      />
      <path
        fill="#19BA19"
        d="M198,73.3c2.9-2.9,2.9-7.6,0-10.5L137.4,2.2c-2.9-2.9-7.6-2.9-10.5,0l-21.7,21.7c-2.9,2.9-7.6,2.9-10.5,0
