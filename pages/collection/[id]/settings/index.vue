    ...
    <div class="adjacent-input">
      <label for="project-visibility">
        ...
        <div class="label__description">
          Public collections will be visible on your profile and via link. Private collections will
          only be able to be viewed by you. Unlisted collections will be visible via link, but not
          on your profile.

          <p>If approved by the moderators:</p>
          <ul class="visibility-info">
            <li>
              <ExitIcon v-if="visibility === 'unlisted' || visibility === 'private'" class="bad" />
