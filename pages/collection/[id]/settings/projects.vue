    ...
    <div class="table">
      <div class="table-row table-head">
        <div class="table-cell">
          <Checkbox :model-value="projects.every(p => p.selected)" @update:model-value="(value) => projects.forEach(p => p.selected = value)"/>
        </div>
        <div class="table-cell">
          Project name
        </div>
      ...
      <div v-for="project in projects" class="table-row" :key="project.id">
        <div class="table-cell">
          <Checkbox v-model="project.selected"/>
        </div>
        <div class="table-cell centered-cell">
          <Avatar :src="project.icon_url" size="sm" class="button-base" @click="$router.push(`/${project.project_type}/${project.slug}`)"/>
          <span class="button-base" @click="$router.push(`/${project.project_type}/${project.slug}`)">{{ project.title }}</span>
        </div>
        <div class="table-cell centered-cell">
          <div>
