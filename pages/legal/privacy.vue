<template>
  <div>
    ...
    <p>
      At Modrinth, accessible from https://modrinth.com, one of our main priorities is the privacy
      of our visitors. This Privacy Policy document contains types of information that is collected
      and recorded by Modrinth and how we use it.
    </p>
    ...
    <p>
      Rinth, Inc. legal basis for collecting and using the personal information described in this
    ...
    <ul>
      ...
      <li>Processing your personal information is in Rinth, Inc. legitimate interests</li>
      <li>Rinth, Inc. needs to comply with the law</li>
    </ul>

    <p>
      Rinth, Inc. will retain your personal information only for as long as is necessary for the
    ...
    <p>
      ...
      it to be removed from our systems, please contact us by email at
      <a href="mailto:gdpr@modrinth.com" rel="noopener noreferrer nofollow"> gdpr@modrinth.com</a>.
    </p>
    ...
    <p>
      Modrinth follows a standard procedure of using log files. These files log visitors when they
    ...
    <p>
      Like any other website, Modrinth uses 'cookies'. These cookies are used to store information
    ...
    <p>
      Modrinth allows creators to enroll in the Creator Monetization Program (the "CMP"). By
      enrolling in the CMP, your PayPal or Venmo email addresses, phone numbers, and usernames will
      be collected. This is required to transfer the money to your account. You may remove this
      information at any time by removing your enrollment in the dashboard or by contacting
      gdpr@modrinth.com.
    </p>
    ...
    <p>
      ...
      Beacons that are used in their respective advertisements and links that appear on Modrinth,
    ...
    <p>
      Note that Modrinth has no access to or control over these cookies that are used by third-party
      advertisers.
    </p>
    ...
    <p>
      Modrinth's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>
      In addition, anytime you click on links (including advertising banners), which take you to
      third-party websites, you will be subject to the third parties’ privacy policies. While we
      support the protection of our customer’s privacy on the Internet, Modrinth expressly disclaims
      any and all liability for the actions of third parties, including but without limitation to
      actions relating to the use and/or disclosure of personal information by third parties.
    </p>

    <p>
      Modrinth makes use of external ads providers. These include EthicalAds. You can read
      EthicalAds's privacy policy here and the data they collect:
