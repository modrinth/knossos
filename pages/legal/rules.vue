<template>
  <div class="markdown-body">
    ...
    <h2 id="additional-provisions">5. Additional Provisions</h2>

    <p>
      There are certain aspects to creating content that are not enforced by Modrinth's moderators
      that all User Contributions should still attempt to abide by.
    </p>
    <ul>
