<template>
  <div class="card">
    ...
    <ul>
      ...
      <li>
        ...
        <ul>
          ...
          <li>automatic PvP</li>
          <li>
            active hiding of client modifications from a server, setting client
            brand to mimic vanilla, or others on a case-by-case basis
          </li>
    ...
    <p>
      ...
      uploaded to our platform which the Modrinth moderators deem is in
      violation of the Terms and/or Rules outlined in this document. Modrinth
      also reserves the right to introduce new rules at any time, which may or
      may not retroactively apply to already uploaded Content at the Modrinth
