  ...
  <div>
    ...
    <section class="universal-card">
      ...
      <div class="theme-options">
        ...
        >
          <div class="preview" :class="`${option === 'system' ? $nativeTheme : option}-mode`">
...
import type { DisplayLocation } from '~/plugins/cosmetics.ts'
...
const $nativeTheme = computed(() => {
  if (import.meta.server && $theme.native !== 'unknown') return $theme.native

  return $mounted.value ? $theme.native : $theme.active
})
