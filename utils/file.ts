...
export function fileIsValid(file: { size: number; name: any }, validationOptions: { maxSize: any; alertOnInvalid: any }) {
...
export function acceptFileFromProjectType(projectType: any) {
  switch (projectType) {
    case 'mod':
